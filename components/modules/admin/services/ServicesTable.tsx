...
function DeleteServiceButton({ id, title }: { id: number; title: string }) {
  ...
  return (
    <>
      ...
      >
        <p style={{ margin: 0 }}>
          Bạn có chắc muốn xóa dịch vụ <strong>"{title}"</strong> không?
        </p>
      </Modal>
    </>
  );
...
export default function ServicesTable({ items }: Props) {
              ...
              {filteredItems.length === 0 ? (
                ...
                filteredItems.map((item, index) => (
                  <tr
                    ...
                    tabIndex={0}
                    role="button"
                    aria-label={`Chỉnh sửa dịch vụ ${item.title}`}
                  >
                    <td>
                    ...
                    <td className={styles.center}>
                      <ToggleStatusButton
                        ...
                        action={toggleServiceVisible}
                        label={
                          item.isVisible ? "Ẩn dịch vụ" : "Hiển thị dịch vụ"
                        }
                      />
                    </td>
                    ...
                    <td className={styles.center}>
                      ...
                      >
                        ...
                        <DeleteServiceButton id={item.id} title={item.title} />
                      </div>
                    </td>
                  </tr>
                ))
